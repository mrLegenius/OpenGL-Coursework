...
public:
	...
	inline static void SetJade(Shader& shader)
	{
		...
		shader.SetUniform1f("u_Material.shininess", 0.1f);
	}
	inline static void SetObsidian(Shader& shader)
	{
		...
		shader.SetUniform1f("u_Material.shininess", 0.3f);
	}
	inline static void SetPearl(Shader& shader)
	{
		...
		shader.SetUniform1f("u_Material.shininess", 0.088f);
	}
	...
	inline static void SetBrass(Shader& shader)
	{
		...
		shader.SetUniform1f("u_Material.shininess", 0.21794872f);
	}
	inline static void SetBronze(Shader& shader)
	{
		...
		shader.SetUniform1f("u_Material.shininess", 0.2f);
	}
	...
	inline static void SetGold(Shader& shader)
	{
		...
		shader.SetUniform1f("u_Material.shininess", 0.4f);
	}
	...
	inline static void SetBlackPlastic(Shader& shader)
	{
		...
		shader.SetUniform1f("u_Material.shininess", 0.25f);
	}
	...
	inline static void SetBlackRubber(Shader& shader)
	{
		...
		shader.SetUniform1f("u_Material.shininess", 0.078125f);
	}
